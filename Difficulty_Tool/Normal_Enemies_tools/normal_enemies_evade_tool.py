...
evade_factor = input('Multiply Normal Enemies Evade by : ')
...
for item in data.values():
    ...
    if item_class == 'ClassWithId':
        ...
        evade_monster = item[1]['Values'][9][1]
        if monster_id <= 1500:  # Check if Monster is Regular/Not Boss
            evade_monster = float(evade_monster)
            evade_monster = evade_monster * evade_factor
            evade_monster = int(evade_monster)
            item2 = item
            item2[1]['Values'][9][1] = evade_monster
...
print("""
You Change all Normal Enemies Evade by x""" + display_evade_factor + """ !!
Enjoy!
""")
