...
sp_atk_factor = input('Multiply Normal Enemies Sp.Attack by : ')
...
for item in data.values():
    ...
    if item_class == 'ClassWithId':
        ...
        sp_atk_monster = item[1]['Values'][6][1]
        if monster_id <= 1500:  # Check if Monster is Regular/Not Boss
            sp_atk_monster = float(sp_atk_monster)
            sp_atk_monster = sp_atk_monster * sp_atk_factor
            sp_atk_monster = int(sp_atk_monster)
            item2 = item
            item2[1]['Values'][6][1] = sp_atk_monster
...
print("""
You Change all Normal Enemies Sp.Attack by x""" + display_sp_atk_factor + """ !!
Enjoy!
""")
