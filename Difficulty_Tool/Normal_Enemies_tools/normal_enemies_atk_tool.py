...
atk_factor = input('Multiply Normal Enemies Attack by : ')
...
for item in data.values():
    ...
    if item_class == 'ClassWithId':
        ...
        atk_monster = item[1]['Values'][4][1]
        if monster_id <= 1500:  # Check if Monster is Regular/Not Boss
            atk_monster = float(atk_monster)
            atk_monster = atk_monster * atk_factor
            atk_monster = int(atk_monster)
            item2 = item
            item2[1]['Values'][4][1] = atk_monster
...
print("""
You Change all Normal Enemies Attack by x""" + display_atk_factor + """ !!
Enjoy!
""")
