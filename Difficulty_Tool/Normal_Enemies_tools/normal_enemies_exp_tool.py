...
exp_factor = input('Multiply Normal Enemies Exp by : ')
...
for item in data.values():
    ...
    if item_class == 'ClassWithId':
        ...
        exp_monster = item[1]['Values'][23][1]
        if monster_id <= 1500:  # Check if Monster is Regular/Not Boss
            exp_monster = float(exp_monster)
            exp_monster = exp_monster * exp_factor
            exp_monster = int(exp_monster)
            item2 = item
            item2[1]['Values'][23][1] = exp_monster
...
print("""
You Change all Normal Enemies Exp by x""" + display_exp_factor + """ !!
Enjoy!
""")
